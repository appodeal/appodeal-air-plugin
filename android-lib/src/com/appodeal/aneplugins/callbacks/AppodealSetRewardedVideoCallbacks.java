...
public class AppodealSetRewardedVideoCallbacks implements FREFunction {
    ...
    public FREObject call(FREContext context, FREObject[] args) {
        ...
        try {
            Appodeal.setRewardedVideoCallbacks(new com.appodeal.aneplugins.callbacks.AppodealRewardedVideoListener(ctx));
