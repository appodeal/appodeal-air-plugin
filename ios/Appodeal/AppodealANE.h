...
DEFINE_ANE_FUNCTION(appodeal_setBannerAnimationEnabled);
DEFINE_ANE_FUNCTION(appodeal_setBannerBackgroundVisible);
DEFINE_ANE_FUNCTION(appodeal_setSmartBannersEnabled);
